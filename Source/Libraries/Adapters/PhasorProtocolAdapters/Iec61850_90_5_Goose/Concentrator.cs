...
using GSF.PhasorProtocols.IEC61850_90_5_Goose;
...
namespace PhasorProtocolAdapters.Iec61850_90_5_Goose
{
    /// <summary>
    /// Represents an IEC 61850-90-5 Goose phasor data concentrator.
    /// </summary>
    public class Concentrator : PhasorDataConcentratorBase
    {
        ...
        public override string Status
        {
            get
            {
                ...
                status.AppendLine("           Output protocol: IEC 61850-90-5 Goose");
        ...
        protected override IFrame CreateNewFrame(Ticks timestamp)
        {
            ...
            // Increment IEC 61850-90-5 Goose sequence numbers
            unchecked
            {
                m_sampleCount++;
                m_packetNumber++;
        ...
        /// <summary>
        /// Creates a new IEC 61850-90-5 Goose (i.e., IEEE C37.118) <see cref="ConfigurationFrame"/> based on provided protocol independent <paramref name="baseConfigurationFrame"/>.
        /// </summary>
        /// <param name="baseConfigurationFrame">Protocol independent <see cref="GSF.PhasorProtocols.Anonymous.ConfigurationFrame"/>.</param>
        ...
        public static ConfigurationFrame CreateConfigurationFrame(GSF.PhasorProtocols.Anonymous.ConfigurationFrame baseConfigurationFrame, uint timeBase, LineFrequency nominalFrequency)
        {
            ...
            foreach (GSF.PhasorProtocols.Anonymous.ConfigurationCell baseCell in baseConfigurationFrame.Cells)
            {
                ...
                foreach (IDigitalDefinition digitalDefinition in baseCell.DigitalDefinitions)
                {
                    ...
                    newCell.DigitalDefinitions.Add(new GSF.PhasorProtocols.IEC61850_90_5_Goose.DigitalDefinition(newCell, digitalDefinition.Label, maskValue.LowWord(), maskValue.HighWord()));
                }
        ...
        /// <summary>
        /// Creates a new IEC 61850-90-5 Goose specific <see cref="DataFrame"/> for the given <paramref name="timestamp"/>.
        /// </summary>
        /// <param name="timestamp">Timestamp for new <see cref="IFrame"/> in <see cref="Ticks"/>.</param>
        ...
        /// <returns>New IEC 61850-90-5 Goose <see cref="DataFrame"/> at given <paramref name="timestamp"/>.</returns>
        ...
        {
            // We create a new IEC 61850-90-5 Goose data frame based on current configuration frame
            ...
            {
                // Create a new IEC 61850-90-5 Goose data cell (i.e., a PMU entry for this frame)
