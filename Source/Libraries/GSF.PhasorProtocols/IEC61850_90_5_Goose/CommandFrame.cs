...
namespace GSF.PhasorProtocols.IEC61850_90_5_Goose
{
    ...
    public class CommandFrame : CommandFrameBase
    {
            ...
            : base(new CommandCellCollection(Common.MaximumExtendedDataLength), DeviceCommand.ReservedBits)
        {
            ...
            if (m_frameHeader.TypeID != IEC61850_90_5_Goose.FrameType.CommandFrame)
        ...
        public CommonFrameHeader CommonHeader
        {
            get
            {
                ...
                if (m_frameHeader == null)
                    m_frameHeader = new CommonFrameHeader(null, IEC61850_90_5_Goose.FrameType.CommandFrame, base.IDCode, base.Timestamp);
