...
namespace GSF.PhasorProtocols.IEC61850_90_5_Goose
{
    ...
    /// </summary>
    [Serializable]
    public class BitStringDefinition : DigitalDefinitionBase
    {
        #region [ Members ]
        ...
        public BitStringDefinition(IConfigurationCell parent)
            : base(parent)
        {
        }
        ...
        public BitStringDefinition(ConfigurationCell parent, string label, ushort normalStatus, ushort validInputs)
            : base(parent, label)
        {
        ...
        protected BitStringDefinition(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        ...
        {
            IDigitalDefinition digitalDefinition = new BitStringDefinition(parent);
